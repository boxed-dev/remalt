...
export default function FooterSection  () {
  ...
  return (
    <footer className="w-full bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8  sm:py-16 ">
