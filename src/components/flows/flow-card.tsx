...
export function FlowCard({ flow, onClick, onDelete, onPublish, isTemplateAdmin }: FlowCardProps) {
  ...
  return (
    <div
      onClick={onClick}
      className="group relative border border-[#E5E7EB] rounded-xl p-6 hover:border-[#095D40] hover:shadow-lg hover:-translate-y-1 transition-all duration-200 cursor-pointer bg-white aspect-[4/3] flex flex-col"
      style={{
