      ...
      {[
        {
          ...
          label: "this workflow",
          action: "Help me understand what this workflow does and suggest improvements",
        },
        {
          title: "Analyze all",
          label: "connected nodes",
          action: "Analyze all the nodes and data in my current workflow",
        },
        {
          title: "Suggest node types",
          label: "for my use case",
          action: "What node types should I add to build a content research workflow?",
        },
        {
          title: "How do I",
          label: "connect nodes effectively?",
          action: "How do I connect nodes to create effective workflows in Remalt?",
        },
